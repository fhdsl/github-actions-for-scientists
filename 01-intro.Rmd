...
This course covers how to use GitHub actions for scientific software development. We encourage the recognition that scientific software can take many forms that can all benefit the concepts of continuous integration and continuous deployment.
...
This course builds on concepts introduced in the [Reproducibility](https://jhudatascience.org/Reproducibility_in_Cancer_Informatics/introduction.html) and [Advanced Reproducibility](https://jhudatascience.org/Adv_Reproducibility_in_Cancer_Informatics/introduction.html) courses from the ITCR Training Network.
...
- Code that is built as a workflow for a series of steps and analyses that might be reused amongst collaborators or within a lab.
...
Ideally you should follow along with the chapters and perform they activities as they are described. These activities involve using GitHub and GitHub actions. You will need a GitHub account and basic familiarity with GitHub and how
